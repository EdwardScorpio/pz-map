...
// @updateURL    https://github.com/EdwardScorpio/pz-map/main/PixelZone%202x2%20PBteam%20map-2.0.7.user.js
// @downloadURL  https://github.com/EdwardScorpio/pz-map/main/PixelZone%202x2%20PBteam%20map-2.0.7.user.js
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
function updateloop() {
    ...
    window.template_list = {
        "Map 1": {
            name: "https://i.ibb.co/6BK9SWc/Pixel-Zone-2x2-map-cut.png",
            x: -4096,
            y: -1473,
            width: 1113,
            height: 2177
